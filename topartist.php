...
function get_artist($country,$pg_size){
    $data = file_get_contents("http://api.musixmatch.com/ws/1.1/chart.artists.get?page=1&page_size=".$pg_size."&country=".$country."&apikey=5f6fff31699c524d735e4a463a1f109f&&format=xml");
